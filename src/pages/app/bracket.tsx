...
import AllParticipants from '../../lib/queries/events/AllParticipants.graphql'
...
const Bracket = () => {
	...
	} = useQuery(AllParticipants, {
		variables: {
			tourneySlug: 'game-lab-mega-monthly-presented-by-plusframesgg'
		}
	})
