...
export type ContactInfoKeySpecifier = (
	| 'city'
	| 'country'
	| 'countryId'
	| 'id'
...
export type EntrantKeySpecifier = (
	| 'event'
	| 'id'
	| 'initialSeedNum'
	| 'isDisqualified'
...
export type EventTeamKeySpecifier = (
	| 'discriminator'
	| 'entrant'
	| 'event'
	| 'globalTeam'
...
export type GameSelectionKeySpecifier = (
	| 'entrant'
	| 'id'
	| 'orderNum'
	| 'participant'
...
export type GlobalTeamKeySpecifier = (
	| 'discriminator'
	| 'entrant'
	| 'event'
	| 'eventTeams'
...
export type LeagueKeySpecifier = (
	| 'addrState'
	| 'city'
	| 'countryCode'
	| 'createdAt'
...
export type PhaseGroupKeySpecifier = (
	| 'bracketType'
	| 'bracketUrl'
	| 'displayIdentifier'
	| 'firstRoundTime'
...
export type ProfileAuthorizationKeySpecifier = (
	| 'externalId'
	| 'externalUsername'
	| 'id'
	| 'stream'
	| 'type'
	| 'url'
	| ProfileAuthorizationKeySpecifier
)[]
...
export type ProgressionKeySpecifier = (
	| 'id'
	| 'originOrder'
	| 'originPhase'
	| 'originPhaseGroup'
	| 'originPlacement'
	| ProgressionKeySpecifier
)[]
...
export type RaceBracketConfigKeySpecifier = (
	| 'automaticEndTime'
	| 'automaticStartTime'
	| 'bracketType'
...
export type RaceMatchConfigKeySpecifier = (
	| 'bracketType'
	| 'id'
	| 'playerReportingEnabled'
	| 'verificationMethods'
	| 'verificationRequired'
	| RaceMatchConfigKeySpecifier
)[]
...
export type SetSlotKeySpecifier = (
	| 'entrant'
	| 'id'
	| 'prereqId'
	| 'prereqPlacement'
...
export type ShopLevelKeySpecifier = (
	| 'currAmount'
	| 'description'
	| 'goalAmount'
	| 'id'
...
export type ShopOrderMessageKeySpecifier = (
	| 'gamertag'
	| 'id'
	| 'message'
	| 'name'
...
export type StandingKeySpecifier = (
	| 'container'
	| 'entrant'
	| 'id'
	| 'isFinal'
...
export type StationsKeySpecifier = (
	| 'canAutoAssign'
	| 'clusterNumber'
	| 'clusterPrefix'
	| 'enabled'
...
export type StreamsKeySpecifier = (
	| 'enabled'
	| 'followerCount'
	| 'id'
	| 'isOnline'
...
export type TeamMemberKeySpecifier = (
	| 'id'
	| 'isAlternate'
	| 'isCaptain'
	| 'memberType'
...
export type TeamRosterSizeKeySpecifier = (
	| 'maxAlternates'
	| 'maxPlayers'
	| 'minAlternates'
	| 'minPlayers'
	| TeamRosterSizeKeySpecifier
)[]
...
export type VideogameKeySpecifier = (
	| 'characters'
	| 'displayName'
	| 'id'
	| 'images'
...
export type StrictTypedTypePolicies = {
	...
	ShopOrderMessageConnection?: Omit<TypePolicy, 'fields' | 'keyFields'> & {
		keyFields?:
			| false
			| ShopOrderMessageConnectionKeySpecifier
			| (() => undefined | ShopOrderMessageConnectionKeySpecifier)
